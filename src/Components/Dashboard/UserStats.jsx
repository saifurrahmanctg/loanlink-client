...
const statMeta = {
  ...
  "Pending Loans": { color: "bg-yellow-500", icon: <FaClock />, prefix: "" },
  "Total Paid": {
  ...
  "Total Users": { color: "bg-indigo-500", icon: <FaUsers />, prefix: "" },
  "Total Loans Issued": {
    color: "bg-cyan-500",
    icon: <FaMoneyCheck />,
    prefix: "",
  ...
  "Loans Paid": { color: "bg-red-500", icon: <FaCheckCircle />, prefix: "৳" },
  "Average Loan Amount": {
    color: "bg-slate-500",
    icon: <FaChartLine />,
    prefix: "৳",
